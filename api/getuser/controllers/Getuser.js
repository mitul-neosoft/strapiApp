...
/**
 * A set of functions called "actions" for `getuser`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific getuser.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific getuser.
   *
   * @return {Object}
   */
